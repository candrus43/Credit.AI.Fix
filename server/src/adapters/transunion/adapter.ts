// ──────────────────────────────────────────────
// CreditBridge — TransUnion Consumer Provider Adapter
// ──────────────────────────────────────────────
//
// Placeholder adapter for TransUnion Consumer direct integration.
// Starts as inactive/not_configured.
// All methods throw "TransUnion consumer integration not yet authorized [TEST]".
...
const NOT_AUTHORIZED_MSG =
  "TransUnion consumer integration not yet authorized [TEST]. " +
  "Direct TransUnion consumer API access requires contractual agreement and credential provisioning.";

export class TransUnionAdapter extends MockAdapterBase {
  constructor(db?: Database) {
    super("TransUnion Consumer", "not_configured", db);
  }

  protected defaultCapabilities(): ProviderCapabilitiesRow {
    return {
      id: 14,
      provider_name: "TransUnion Consumer",
      ...
      required_agreements: "TransUnion developer agreement",
      api_documentation_reference: "https://www.transunion.com/developer",
      last_verification_date: null,
      production_approval_status: "not_approved",
      internal_notes:
        "[TEST] TransUnion Consumer mock adapter. Integration not yet authorized. " +
