// ──────────────────────────────────────────────
// CreditBridge — Equifax Consumer Provider Adapter
// ──────────────────────────────────────────────
//
// Placeholder adapter for Equifax Consumer direct integration.
// Starts as inactive/not_configured.
// All methods throw "Equifax consumer integration not yet authorized [TEST]".
...
const NOT_AUTHORIZED_MSG =
  "Equifax consumer integration not yet authorized [TEST]. " +
  "Direct Equifax consumer API access requires contractual agreement and credential provisioning.";

export class EquifaxAdapter extends MockAdapterBase {
  constructor(db?: Database) {
    super("Equifax Consumer", "not_configured", db);
  }

  protected defaultCapabilities(): ProviderCapabilitiesRow {
    return {
      id: 13,
      provider_name: "Equifax Consumer",
      ...
      required_agreements: "Equifax Developer Network agreement",
      api_documentation_reference: "https://developer.equifax.com/",
      last_verification_date: null,
      production_approval_status: "not_approved",
      internal_notes:
        "[TEST] Equifax Consumer mock adapter. Integration not yet authorized. " +
  ...
  // Override all data-access methods to throw the not-authorized message.
  // Identity methods still work for capability inspection.
